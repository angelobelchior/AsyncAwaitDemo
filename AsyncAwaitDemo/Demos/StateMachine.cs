...
{
    public static async Task ExecuteBlogService()
    {
    ...
    public static async Task ExecuteBlogServiceStatemachine()
    {
        var blog = new BlogServiceStatemachine();
        var post = await blog.ObterPostPorIdAsync(1);
        Console.WriteLine(post);
    }
}
...
public class BlogServiceStatemachine
{
